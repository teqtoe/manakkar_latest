...
class OptionSeeder extends Seeder
{
    ...
    public function run()
    {
        $options = array (
            ...
            'site_url' => 'http://localhost/teqtoe/source/public',
            ...
            'about_us_page' => '3',
            'cookie_alert' => 'json_encode_value_{"enable":"1","message":"By using teqtoeLMS you accept our cookies and agree to our privacy policy, including cookie policy. {privacy_policy_url}"}',
