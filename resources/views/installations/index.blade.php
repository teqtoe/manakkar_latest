...
<head>
    ...
    <!-- teqtoe Version -->
    <meta name="generator" content="teqtoe LMS v.{{config('app.version')}}" />
            ...
            <div class="installations-header my-4 text-center">
                ...
                <div class="installations-logo">
                    <h4 class="mt-3 d-flex justify-content-center">
                        <img src="{{asset('assets/images/teqtoe-lms-logo.svg')}}" />
                        <span class="ml-3">Installations Wizard</span>
                    </h4>
                </div>
                <h5 class="text-info my-3">Server Requirements for the teqtoe LMS</h5>
            </div>
